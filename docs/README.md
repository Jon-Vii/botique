...
- `agent-loop.md`: shop-owner agent loop, briefing format, scratchpad/journal behavior, and tournament relationship
...
- `src/agent_runtime/`: Python owner-agent runtime with single-shop and tournament modes, artifact bundles, scratchpad/journal/reminder memory, and provider wiring
